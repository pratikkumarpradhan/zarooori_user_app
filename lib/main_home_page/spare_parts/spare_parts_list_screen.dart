...
class SparePartsListScreen extends StatefulWidget {
  ...
  const SparePartsListScreen({super.key, required this.productRequest});

  @override
  State<SparePartsListScreen> createState() => _SparePartsListScreenState();
}
                ...
                children: [
                  TextField(
                    ...
                    decoration: PremiumDecorations.textField(
                      hintText: 'Search by company, part name, code...',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _errorMsg ?? 'Failed to load spare parts',
