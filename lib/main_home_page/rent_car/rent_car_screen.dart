        ...
        actions: [
          Container(
            ...
            child: IconButton(
              ...
              onPressed: () async {
                final req =
                    await Get.to<ProductRequest>(() => SearchProductScreen(
                          mainCatId: '11',
                ...
                if (req != null && mounted) {
                  Get.off(() =>
                      RentCarScreen(productRequest: req));
                }
              },
            ),
          ),
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          highlightColor:
              const Color(0xFFFFF59D).withOpacity(0.2),
          child: Column(
            crossAxisAlignment:
...
//   const _ModernProductCard({required this.product, required this.onTap});
