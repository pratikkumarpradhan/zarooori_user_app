...
//         VehicleInsuranceApi.getSubCategories(widget.mainCatId),
//       ]);
//       if (!mounted) return;
//       setState(() {
//         _brandsList = results[0] as List<BrandsTypesModels>;
//         _yearsList = results[1] as List<YearItem>;
//         _subTypes = results[2] as List<SubCategory>;
//         _isLoading = false;
//       });
//     } catch (e) {
//       if (mounted) {
...
//           : null,
//       master_subcategory_id: _subTypes.isNotEmpty && _subIndex < _subTypes.length
//           ? _subTypes[_subIndex].id
//           : null,
...
//           onPressed: () => Get.back(),
//         ),
//         title: Text(widget.screenTitle, style: AppTextStyles.textView(size: 18, color: AppColors.black)),
//       ),
//       body: _isLoading
...
//                             _buildDropdown(
//                               value: _subTypes.isEmpty || _subIndex >= _subTypes.length
//                                   ? ''
//                                   : (_subTypes[_subIndex].sub_cat_name ?? ''),
//                               hint: 'Select',
//                               onTap: () => _showPicker(
//                                 items: _subTypes.map((e) => e.sub_cat_name ?? '').toList(),
//                                 selected: _subIndex,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (_, i) => InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: i == selected ? const Color(0xFFFFB300).withValues(alpha: 0.2) : Colors.transparent,
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            ).copyWith(fontWeight: i == selected ? FontWeight.w600 : FontWeight.normal),
                          ),
                        ),
                        if (i == selected)
                          Icon(Icons.check_circle, color: const Color(0xFFFFB300), size: 20),
                      ],
                    ),
                  ),
                ),
                                ...
                                children: [
                                  ...
                                  _buildDropdown(
                                    value: _brandsList.isEmpty ||
                                            ...
                                            _typeIndex >= _brandsList[_brandIndex].type_list.length
                                        ? ''
                                        : (_brandsList[_brandIndex].type_list[_typeIndex].model_list.isEmpty
                                            ? ''
                                            : _brandsList[_brandIndex].type_list[_typeIndex].model_list[_modelIndex]
                                                    .vehicle_model_name ??
                                                ''),
                                    hint: 'Select Model',
                                    onTap: () {
